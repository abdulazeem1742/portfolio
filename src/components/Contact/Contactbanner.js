        ...
        <div className='row'>
            <div className='col-12 col-md-12 col-lg-12'>
                <div className='banner-st1'>
                    <p className='banner-title text-center'>
                        Contact Me
                    </p>
                </div>
            </div>
        </div>
        <img src='../../images/leaf-cyan-lg.png' className='img-fluid banner-img3' />
        <img src='../../images/dots-group-cyan.png' className='img-fluid banner-img4' />
